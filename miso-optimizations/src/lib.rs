...
use project_propagation::{ProjectPropagationWithSummarize, ProjectPropagationWithoutSummarize};
    ...
    pub fn with_dynamic_filtering(max_distinct_values: u32) -> Self {
        Self::new(vec![
            ...
            vec![
                ...
                opt!(ProjectPropagationWithSummarize),
                opt!(ProjectPropagationWithoutSummarize),
                // Filter.
