...
macro_rules! pattern {
    (@inner ^) => {
        $crate::pattern::CompPattern::Start
    };
    (@inner $) => {
        $crate::pattern::CompPattern::End
    };
    (@inner .) => {
        $crate::pattern::CompPattern::Any
    };
    (@inner *) => {
        $crate::pattern::CompPattern::ZeroOrMore
    };
    (@inner +) => {
        $crate::pattern::CompPattern::OneOrMore
    };
    (@inner ?) => {
        $crate::pattern::CompPattern::Optional
    };
    (@inner [$($variant:ident)+]) => {
        $crate::pattern::CompPattern::Range(vec![$($crate::WorkflowStepKind::$variant),+])
    };
    (@inner [^$($variant:ident)+]) => {
        $crate::pattern::CompPattern::NotRange(vec![$($crate::WorkflowStepKind::$variant),+])
    };
    (@inner $variant:ident) => {
        $crate::pattern::CompPattern::Exact($crate::WorkflowStepKind::$variant)
    };
    (@inner ($($inner:tt)+)) => {
        $crate::pattern::CompPattern::Group(vec![$(pattern!(@inner $inner)),+])
    };
    (@inner $($inner:tt)+) => {{
        $crate::pattern::CompPattern::Sequence(vec![$(pattern!(@inner $inner)),+])
    }};
